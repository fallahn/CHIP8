...
static const std::vector<sf::Uint8> testRom = //TODO convert to std::array
{
    ...
    0x60, 0x1E,                   //0x28A set V0 to X coord
    0x22, 0x3A,                   //0x28C goto draw/delay sub
    0xA2, 0x2F,                   //0x28E set I reg to !
    0x60, 0x23,                   //0x290 set V0 to X coord
    ...
    0x07, 0xE0, 0x18, 0x18, 0x27, 0xE4, 0x4C, 0x32, //0x2AC
    0x48, 0x12, 0x88, 0x11, 0xCC, 0x33, 0x67, 0xE6, //0x2B4
    0x67, 0xE6, 0xCC, 0x33, 0x88, 0x11, 0x48, 0x12, //0x2BC
    0x4C, 0x32, 0x27, 0xE4, 0x18, 0x18, 0x07, 0xE0, //0x2C4

    0x60, 0x2B,                   //0x2CC set v0 to X coord
    0x61, 0x08,                   //0x2CE set V1 to Y coord
