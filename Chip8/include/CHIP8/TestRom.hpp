...
static const std::vector<sf::Uint8> testRom = //TODO convert to std::array
{
    ...
    //charset
    0xF0, 0x80, 0x80, 0x80, 0xF0, //0x202 C
    0xF0, 0x80, 0xF0, 0x80, 0xF0, //0x207 E
    0x90, 0x90, 0xF0, 0x90, 0x90, //0x20C H
    0xE0, 0x40, 0x40, 0x40, 0xE0, //0x211 I
    0x90, 0x50, 0x60, 0x50, 0x90, //0x216 K
    0xF0, 0x90, 0x90, 0x90, 0xF0, //0x21B O
    0xF0, 0x90, 0xF0, 0x80, 0x80, //0x220 P
    0xF0, 0x80, 0xF0, 0x10, 0xF0, //0x225 S
    0xE0, 0x40, 0x40, 0x40, 0x40, //0x22A T
    0x40, 0x40, 0x40, 0x00, 0x40, //0x22F !
    0x06, 0x90, 0x06, 0x90, 0x06, //0x234 8
